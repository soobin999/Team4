	...
	<div class="offcanvas-menu-wrapper">
		...
		<div class="header-configure-area">
			<div class="language-option">
				<img src="${pageContext.request.contextPath}/resources/img/flag.jpg" alt=""> <span>EN <i
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="hp-room-item set-bg" data-setbg="${pageContext.request.contextPath}/resources/img/room/room-b1.jpg">
                            <div class="hr-text">
                                <h3>Double Room</h3>
                                <h2>50 000￦<span>/Pernight</span></h2>
                                <table>
                                    <tbody>
                                        <tr>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="hp-room-item set-bg" data-setbg="${pageContext.request.contextPath}/resources/img/room/room-b2.jpg">
                            <div class="hr-text">
                                <h3>Premium Room</h3>
                                <h2>100 000￦<span>/Pernight</span></h2>
                                <table>
                                    <tbody>
                                        <tr>
                                            <td class="r-o">Size:</td>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="hp-room-item set-bg" data-setbg="${pageContext.request.contextPath}/resources/img/room/room-b3.jpg">
                            <div class="hr-text">
                                <h3>Standart Room</h3>
                                <h2>30 000￦<span>/Pernight</span></h2>
                                <table>
                                    <tbody>
                                        <tr>
                                            <td class="r-o">Size:</td>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="hp-room-item set-bg" data-setbg="${pageContext.request.contextPath}/resources/img/room/room-b4.jpg">
                            <div class="hr-text">
                                <h3>Family Room</h3>
                                <h2>150 000￦<span>/Pernight</span></h2>
                                <table>
                                    <tbody>
                                        <tr>
                                            <td class="r-o">Size:</td>
		...
		<tbody>
			<c:forEach items="${room}" var="room">
				<tr>
					...
					<td>${room.reservationState}</td>
					<td>${room.roomPrice}</td>
					<td>${room.roomSalePrice}</td>
					<td>${room.roomPicture}</td>
					<td>${room.roomPerson}</td>
					<td>${room.roomTypeCount}</td>
					<td>${room.roomInformftion}</td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
